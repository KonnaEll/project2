...
void classic_assign(char**, int, int, int, double**, double**, int, int, FILE*);
...
void frechet_classic_assign(char**, int, int, int, double**, double**, int, int, FILE*);
void frechet_lsh_assign(double**, double**, char**, int, int, int, double**, double**, int, int, FILE*, int);
