...
int main(int argc, char* argv[])
{
    ...
    else if(strcmp(algorithm, "Hypercube") == 0)
    {
        for(int n=0; n<L; n++)
        {
            cube_for_vectors(input_items_counter, names, query_items_counter, query_names, dimension, curves, query_curves, output_file_ptr, k, n,probes,M);
        }
    ...
    else if(strcmp(algorithm, "Frechet") == 0)
    {
        if(strcmp(metric, "discrete") == 0)
        {
            ...
            for(int n=0; n<L; n++)
            {
                ...
                lsh_for_frechet(vectors, input_items_counter, names, query_vectors, query_items_counter, query_names, dimension, curves, query_curves, output_file_ptr, k, delta, t, n);
            }
        }
