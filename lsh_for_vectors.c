...
void lsh_for_vectors(double** vectors, int input_items_counter, int dimension, int k, int L, char** names, char* query_file, double delta, char* output_file, double** curves, float* t, int n)
{
